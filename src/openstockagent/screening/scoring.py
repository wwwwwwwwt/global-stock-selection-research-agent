...
DEFAULT_SCREEN_CONFIG: dict[str, Any] = {
    ...
    "components": {
        ...
        "volume_score": ["volume_expansion_20d", "volume_ratio"],
        "volatility_score": ["atr_14d", "max_drawdown_20d"],
        "liquidity_score": ["turnover_amount_20d", "turnover_rate", "turnover_rate_f"],
        "valuation_score": ["pe_ttm", "pb", "ps_ttm", "dv_ttm"],
        "size_score": ["total_mv", "circ_mv"],
